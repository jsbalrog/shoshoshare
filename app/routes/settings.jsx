        ...
        >
          ...
          <motion.div variants={itemVariants} className="bg-white dark:bg-gray-800 shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <motion.div variants={formVariants} className="mt-6">
              ...
              <motion.div variants={formVariants} className="mt-6">
                <div className="rounded-md bg-blue-50 dark:bg-blue-900 p-4">
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-blue-800 dark:text-blue-200">Current Plan: Free</h3>
                      <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                        <p>Upgrade to our Pro plan to unlock all features and increase your monthly post limit.</p>
                      </div>
                    </div>
                  </div>
                </div>
